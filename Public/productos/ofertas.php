...
<main class="Perfumes content" data-categoria="oferta">
    ...
    <div class="Perfumes__Container">
        <?php foreach ($productos as $producto): ?>
            ...
            <div class="Perfumes__Container__Item">
                ...
                <div class="precios">
                    <p class="precio-normal"><?php echo $producto["Precio"] ?></p>
                    <p class="precio precioProducto"><?php echo $producto["PrecioDescuento"] ?></p>
                </div>
                ...
                <input type="hidden" value="<?php echo $producto["Marca"] ?>" name="Genero_producto" id="Genero_producto" />

                <a class="btnAddCar Boton-1"
                    href="#"
                    data-id="<?php echo $producto["Id"] ?>"
                    data-nombre="<?php echo htmlspecialchars($producto["NombreProducto"]) ?>"
                    data-precio="<?php echo $producto["PrecioDescuento"] ?>"
